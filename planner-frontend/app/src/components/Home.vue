    ...
    <div class="main-content">
          ...
          <div class="navbar-header">
            <div class="d-flex align-items-center">
              <div class="navbar-brand-box mr-3 mr-lg-5">
                <a href="index.html" class="logo">
                  <span class="d-none d-lg-block">
                    <img src="assets/images/logo-dark.png" alt="" height="15" />
                  </span>
                  <i class="d-lg-none">
                    <img
              ...
              <div class="header-breadcumb">
                <h2 class="header-title">Planner</h2>
              </div>
            </div>
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown d-inline-block ml-1">
                ...
                >
                  ...
                  <div class="custom-scroll" style="max-height: 230px">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  <a
                    ...
                    aria-expanded="false"
                  >
                    <i class="feather-copy mr-2"></i>Pages
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="topnav-auth">
                        ...
                        <a href="auth-lock-screen.html" class="dropdown-item"
                          >Lock Screen</a
                        >
                        <a href="auth-404.html" class="dropdown-item"
                          >Error 404</a
                        >
                        <a href="auth-500.html" class="dropdown-item"
                          >Error 500</a
                        >
                      </div>
                    </div>
                    <a href="pages-invoice.html" class="dropdown-item"
                      >Invoice</a
                    >
                ...
                <li class="nav-item dropdown">
                  <a
                    ...
                    aria-expanded="false"
                  >
                    <i class="feather-briefcase mr-2"></i>UI Elements
                    <div class="arrow-down"></div>
                  </a>
                  <div
                    class="dropdown-menu"
                  ...
                  >
                    ...
                    <a href="ui-tooltips-popovers.html" class="dropdown-item"
                      >Tooltips & Popovers</a
                    >
                    <a href="ui-media-objects.html" class="dropdown-item"
                      >Media Objects</a
                    >
                    <a href="ui-general.html" class="dropdown-item">General</a>
                    <a href="ui-grid.html" class="dropdown-item">Grid</a>
                    <a href="ui-spinners.html" class="dropdown-item"
                      >Spinners</a
                    >
                    <a href="ui-scrollspy.html" class="dropdown-item"
                      >Scrollspy</a
                    >
                    <a href="ui-sweetalerts.html" class="dropdown-item"
                      >Sweet Alerts</a
                    >
                  </div>
                </li>
                ...
                <li class="nav-item dropdown">
                  <a
                    ...
                    aria-expanded="false"
                  >
                    <i class="feather-bar-chart-2 mr-2"></i>Charts
                    <div class="arrow-down"></div>
                  </a>
                  <div class="dropdown-menu" aria-labelledby="topnav-charts">
                    <a href="charts-morris.html" class="dropdown-item"
                      >Morris</a
                    >
                    <a href="charts-google.html" class="dropdown-item"
                      >Google</a
                    >
                ...
                <li class="nav-item dropdown">
                  <a
                    ...
                    aria-expanded="false"
                  >
                    <i class="feather-disc mr-2"></i>Forms
                    <div class="arrow-down"></div>
                  </a>
                  <div class="dropdown-menu" aria-labelledby="topnav-forms">
                    <a href="forms-elements.html" class="dropdown-item"
                      >Elements</a
                    >
                    <a href="forms-plugins.html" class="dropdown-item"
                      >Plugins</a
                    >
                    ...
                    <a href="forms-quilljs.html" class="dropdown-item"
                      >Quilljs</a
                    >
                    <a href="forms-uploads.html" class="dropdown-item"
                      >File Uploads</a
                    >
                  </div>
                </li>
                ...
                <li class="nav-item dropdown">
                  <a
                    ...
                    aria-expanded="false"
                  >
                    <i class="feather-book-open mr-2"></i>More
                    <div class="arrow-down"></div>
                  </a>
                    ...
                    <div class="dropdown">
                      ...
                      >
                        <a href="tables-basic.html" class="dropdown-item"
                          >Basic Tables</a
                        >
                        <a href="tables-datatables.html" class="dropdown-item"
                          >Data Tables</a
                        >
                      </div>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-subtitle mb-4">
                    From date of 1st Jan 2019 to continue
                  </p>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              <div class="text-center text-lg-left">2019 © Drezoc</div>
            </div>
            <div class="col-md-6">
